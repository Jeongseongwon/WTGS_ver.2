...
{
    static public string COURSE_NAME = "2022_풍력발전_감시/제어_시스템"; // "해당 개발년도_해당 콘텐츠명"으로 수정
    static public string COURSE_NAME_ENG = "2022_WINDTURBINE"; // "해당 개발년도_해당 콘텐츠명의 영문 약식 표현"으로 수정
    ...
    public virtual void UpdateResultStatement(int score, bool complete) { }
