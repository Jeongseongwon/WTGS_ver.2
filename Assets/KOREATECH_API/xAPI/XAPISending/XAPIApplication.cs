...
public class XAPIApplication : MonoBehaviour
{
    ...
    public bool SelectActiveLesson(string chapterName)
    {
        switch (chapterName)
        {
            ...
            case "0": activeLesson = firstLesson; break;
            case "1": activeLesson = secondLesson; break;
            case "2": activeLesson = thirdLesson; break;
    ...
    private JObject JSONBody()
    {
        ...
        //평가코드 및 평가명 설정 부분
        lesson_code = new JProperty("lession_code", ""); // "" 부분 수정
        lesson_name = new JProperty("lession_name", ""); // "" 부분 수정
    ...
    public void SendChoiceVT(string item, bool success, int step)
    {
        ...
        JProperty lesson_score = new JProperty("lession_item_score", 0);
